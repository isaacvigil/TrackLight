...
export function EditableRemoteStatusCell({ applicationId, value }: EditableRemoteStatusCellProps) {
  ...
  return (
    <Select value={currentValue} onValueChange={handleChange} disabled={isSaving}>
      <SelectTrigger className="h-10 w-full border border-border focus:ring-0 text-base font-normal rounded-none !bg-transparent dark:!bg-transparent hover:!bg-transparent">
        <SelectValue>
